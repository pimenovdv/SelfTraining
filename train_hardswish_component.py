...
def hardswish_backward(x, grad_output):
    """
    ...
    if -3 < x < 3: x/3 + 0.5
    """
    grad = np.where(x <= -3, 0, np.where(x >= 3, 1, x / 3 + 0.5))
...
print("Hardswish component trained successfully.")
