...
- [x] Explore Local Response Normalization mathematically. (Implemented and verified Local Response Normalization - LRN).
- [x] Explore Instance Normalization mathematically. (Implemented and verified Instance Normalization).
