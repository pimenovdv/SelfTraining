...
- [x] Explore state estimation in non-linear, non-Gaussian systems mathematically. (Implemented and verified Particle Filter evaluating sequential Monte Carlo for tracking).
